<div class="ststa">
    ...
    <? 
        $rezerv = $wpdb->get_results("SELECT * FROM `kn_ches_home` WHERE `home` = '".$h->home."' AND   (`status` = 'Резерв' OR `status` = 'Резерв руководителя') AND `rooms` = 1");
    ...
    <? 
        $prod = $wpdb->get_results("SELECT * FROM `kn_ches_home` WHERE `home` = '".$h->home."' AND   (`status` = 'Продана' OR `status` = 'Резерв учередителя') AND `rooms` = 1");
    ...
    <? 
        $rezerv = $wpdb->get_results("SELECT * FROM `kn_ches_home` WHERE `home` = '".$h->home."' AND   (`status` = 'Резерв' OR `status` = 'Резерв руководителя') AND `rooms` = 2");
    ...
    <? 
        $prod = $wpdb->get_results("SELECT * FROM `kn_ches_home` WHERE `home` = '".$h->home."' AND   (`status` = 'Продана' OR `status` = 'Резерв учередителя') AND `rooms` = 2");
    ...
    <? 
        $rezerv = $wpdb->get_results("SELECT * FROM `kn_ches_home` WHERE `home` = '".$h->home."' AND   (`status` = 'Резерв' OR `status` = 'Резерв руководителя') AND `rooms` = 3");
    ...
    <? 
        $prod = $wpdb->get_results("SELECT * FROM `kn_ches_home` WHERE `home` = '".$h->home."' AND   (`status` = 'Продана' OR `status` = 'Резерв учередителя') AND `rooms` = 3");
    ...
    <? 
        $rezerv = $wpdb->get_results("SELECT * FROM `kn_ches_home` WHERE `home` = '".$h->home."' AND   (`status` = 'Резерв' OR `status` = 'Резерв руководителя')");
    ...
    <? 
        $prod = $wpdb->get_results("SELECT * FROM `kn_ches_home` WHERE `home` = '".$h->home."' AND  (`status` = 'Продана' OR `status` = 'Резерв учередителя')");
