	...
	<section id="uslugi_main" class="uslugi_main">
		<div class="container">
			...
			<div class="usl_in_main">
				...
				<a href = "<? echo get_the_permalink(158); ?>" class="uni_blk" style = "background-image: url(<? $bg_img = carbon_get_post_meta(158, "banner_img"); echo empty($bg_img)?get_bloginfo("template_url")."/img/sell-bg.jpg":$bg_img; ?>)">
					<h3><?echo get_the_title(158); ?></h3>
				</a>
				

				<a href = "<? echo get_the_permalink(160); ?>" class="uni_blk" style = "background-image: url(<? $bg_img = carbon_get_post_meta(160, "banner_img"); echo empty($bg_img)?get_bloginfo("template_url")."/img/sell-bg.jpg":$bg_img; ?>)">
					<h3><?echo get_the_title(158); ?></h3>
				</a>

				<a href = "<? echo get_the_permalink(162); ?>" class="uni_blk" style = "background-image: url(<? $bg_img = carbon_get_post_meta(162, "banner_img"); echo empty($bg_img)?get_bloginfo("template_url")."/img/sell-bg.jpg":$bg_img; ?>)">
					<h3><?echo get_the_title(158); ?></h3>
				</a>

				<a href = "<? echo get_the_permalink(164); ?>" class="uni_blk" style = "background-image: url(<? $bg_img = carbon_get_post_meta(164, "banner_img"); echo empty($bg_img)?get_bloginfo("template_url")."/img/sell-bg.jpg":$bg_img; ?>)">
					<h3><?echo get_the_title(158); ?></h3>
				</a>
			</div>
		</div>
